...
posthog = PostHog::Client.new({
   ...
   personal_api_key: "phx_DvugINPCOSM3Ko929TaeywnUlRC5FeF4X7KV60IgyXWGTLw", # Required for local feature flag evaluation
...
puts posthog.get_decrypted_feature_flag_payload(257)
